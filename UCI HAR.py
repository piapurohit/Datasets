...
x_train = __load_X(train_paths)
x_test = __load_X(test_paths)
y_train = np.loadtxt('C:/Users/Pia Purohit/PycharmProjects/Datasets/UCI HAR Dataset/UCI HAR Dataset/train/y_train.txt',  dtype=np.int32)
y_test = np.loadtxt('C:/Users/Pia Purohit/PycharmProjects/Datasets/UCI HAR Dataset/UCI HAR Dataset/test/y_test.txt', dtype=np.int32)
